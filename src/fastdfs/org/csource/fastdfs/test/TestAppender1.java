...
public class TestAppender1
{
  ...
  public static void main(String args[])
  {
  	...
  	try
  	{
  		FdfsClientConfig.init(conf_filename);
  		...
  		*/
  		...
  		file_buff = "this is a test".getBytes(FdfsClientConfig.g_charset);
  		...
  		*/
  		...
  		else
  		{
  			...
  			file_buff = "this is a slave buff".getBytes(FdfsClientConfig.g_charset);
  			file_ext_name = "txt";
				startTime = System.currentTimeMillis();
  		...
  		if (appender_file_id != null)
  		{
  			...
  			if (FdfsClientConfig.g_tracker_http_port != 80)
  			{
  				 file_url += ":" + FdfsClientConfig.g_tracker_http_port;
  			}
  			file_url += "/" + appender_file_id;
  			if (FdfsClientConfig.g_anti_steal_token)
  			{
	  			ts = (int)(System.currentTimeMillis() / 1000);
	  			token = ProtoCommon.getToken(appender_file_id, ts, FdfsClientConfig.g_secret_key);
