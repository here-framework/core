...
*/
	public static Socket getSocket(String ip_addr, int port) throws IOException
	{
		...
		sock.setSoTimeout(FdfsClientConfig.g_network_timeout);
		sock.connect(new InetSocketAddress(ip_addr, port), FdfsClientConfig.g_connect_timeout);
		return sock;
	}
...
*/
	public static Socket getSocket(InetSocketAddress addr) throws IOException
	{
		Socket sock = new Socket();
		sock.setSoTimeout(FdfsClientConfig.g_network_timeout);
		sock.connect(addr, FdfsClientConfig.g_connect_timeout);
		return sock;
	}
	...
	{
		FdfsClientConfig.g_connect_timeout = connect_timeout;
	}
	...
	{
		FdfsClientConfig.g_network_timeout = network_timeout;
	}
	...
	{
		FdfsClientConfig.g_charset = charset;
	}
	...
	{
		FdfsClientConfig.g_tracker_http_port = tracker_http_port;
	}
	...
	{
		FdfsClientConfig.g_anti_steal_token = anti_steal_token;
	}
	...
	{
		FdfsClientConfig.g_secret_key = secret_key;
	}
	...
	{
		FdfsClientConfig.g_tracker_group = tracker_group;
	}
}
