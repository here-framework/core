...
*/
public class ClientGlobal_copy
{
...
*/
	public static void init(String conf_filename) throws FileNotFoundException, IOException, FdfsException
	{
  		...
  		{
  			throw new FdfsException("item \"tracker_server\" in " + conf_filename + " not found");
  		}
...
*/
	public static Socket getSocket(String ip_addr, int port) throws IOException
	{
		...
		sock.setSoTimeout(ClientGlobal_copy.g_network_timeout);
		sock.connect(new InetSocketAddress(ip_addr, port), ClientGlobal_copy.g_connect_timeout);
		return sock;
	}
...
*/
	public static Socket getSocket(InetSocketAddress addr) throws IOException
	{
		Socket sock = new Socket();
		sock.setSoTimeout(ClientGlobal_copy.g_network_timeout);
		sock.connect(addr, ClientGlobal_copy.g_connect_timeout);
		return sock;
	}
	...
	{
		ClientGlobal_copy.g_connect_timeout = connect_timeout;
	}
	...
	{
		ClientGlobal_copy.g_network_timeout = network_timeout;
	}
	...
	{
		ClientGlobal_copy.g_charset = charset;
	}
	...
	{
		ClientGlobal_copy.g_tracker_http_port = tracker_http_port;
	}
	...
	{
		ClientGlobal_copy.g_anti_steal_token = anti_steal_token;
	}
	...
	{
		ClientGlobal_copy.g_secret_key = secret_key;
	}
	...
	{
		ClientGlobal_copy.g_tracker_group = tracker_group;
	}
}
