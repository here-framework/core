...
*/
	public void setFields(byte[] bs, int offset,FdfsClientConfig clientConfig)
	{
		this.status = byteValue(bs, offset, fieldsArray[FIELD_INDEX_STATUS]);
		this.id = stringValue(bs, offset, fieldsArray[FIELD_INDEX_ID],clientConfig);
		this.ipAddr = stringValue(bs, offset, fieldsArray[FIELD_INDEX_IP_ADDR],clientConfig);
		this.srcIpAddr = stringValue(bs, offset, fieldsArray[FIELD_INDEX_SRC_IP_ADDR],clientConfig);
		this.domainName = stringValue(bs, offset, fieldsArray[FIELD_INDEX_DOMAIN_NAME],clientConfig);
		this.version = stringValue(bs, offset, fieldsArray[FIELD_INDEX_VERSION],clientConfig);
