...
*/
	public abstract void setFields(byte[] bs, int offset,FdfsClientConfig clientConfig);
	
	protected String stringValue(byte[] bs, int offset, FieldInfo filedInfo,FdfsClientConfig clientConfig)
	{
		try
		{
			return (new String(bs, offset + filedInfo.offset, filedInfo.size, clientConfig.g_charset)).trim();
		}
