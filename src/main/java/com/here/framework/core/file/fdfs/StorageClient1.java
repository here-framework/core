...
*/
	...
	*/
	...
	public String upload_file1(InputStream fileStream, int fileSize,String file_ext_name, 
		       NameValuePair[] meta_list) throws IOException, FdfsException
		{
			String parts[] = this.upload_file(fileStream,fileSize,file_ext_name, meta_list);
			if (parts != null)
			{
				return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
			}
  ...
  * @return file id(including group name and filename) if success, <br>
	...
	*/
	public int append_file1(String appender_file_id, String local_filename) throws IOException, FdfsException
	{
		String[] parts = new String[2];
	...
	* @return 0 for success, != 0 for error (error no)
	*/
	public int append_file1(String appender_file_id, byte[] file_buff) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0)
	...
	* @return 0 for success, != 0 for error (error no)
	*/
	public int append_file1(String appender_file_id, byte[] file_buff, int offset, int length) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0)
	...
	* @return 0 for success, != 0 for error (error no)
	*/
	public int append_file1(String appender_file_id, long file_size, UploadCallback callback) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0)
	...
	*/
	public int delete_file1(String file_id) throws IOException, FdfsException
	{
		String[] parts = new String[2];
  ...
  * @param appender_file_id the appender file id
	* @return 0 for success, none zero for fail (error code)
	*/
	public int truncate_file1(String appender_file_id) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0)
  ...
  * @param appender_file_id the appender file id
	...
	* @return 0 for success, none zero for fail (error code)
	*/
	public int truncate_file1(String appender_file_id, long truncated_file_size) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0)
	...
	*/
	public byte[] download_file1(String file_id) throws IOException, FdfsException
	{
	...
	*/
	public byte[] download_file1(String file_id, long file_offset, long download_bytes) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0)
	...
	*/
	public int download_file1(String file_id, String local_filename) throws IOException, FdfsException
	{
		final long file_offset = 0;
		final long download_bytes = 0;
	...
	* @return 0 success, return none zero errno if fail
	*/
	public int download_file1(String file_id, long file_offset, long download_bytes, String local_filename) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0)
	...
	* @return 0 success, return none zero errno if fail
	*/
	public int download_file1(String file_id, DownloadCallback callback) throws IOException, FdfsException
	{
		final long file_offset = 0;
		final long download_bytes = 0;
	...
	* @return 0 success, return none zero errno if fail
	*/
	public int download_file1(String file_id, long file_offset, long download_bytes, DownloadCallback callback) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0)
	...
	*/
	public NameValuePair[] get_metadata1(String file_id)throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0)
	...
	*/
	public int set_metadata1(String file_id, NameValuePair[] meta_list, byte op_flag) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0)
	...
	*/
	public FileInfo query_file_info1(String file_id) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0)
	...
	* @return FileInfo object for success, return null for fail
	*/
	public FileInfo get_file_info1(String file_id) throws IOException, FdfsException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0)
